module github.com/marcellustavares/go-zetasqlite/cmd/zetasqlite-cli
...
require (
	...
	github.com/marcellustavares/go-zetasqlite v0.4.0
...
replace github.com/marcellustavares/go-zetasqlite => ../../
